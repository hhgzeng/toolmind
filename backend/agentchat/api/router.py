...
from agentchat.api.v1 import (chat, dialog, message, history, mcp_stdio_server, mcp_chat, # agent, mars, tool
                              user, llm, knowledge, knowledge_file, mcp_agent, mcp_server, mcp_user_config,
...
# router.include_router(mars.router) # 探索模块
